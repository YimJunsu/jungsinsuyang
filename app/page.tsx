...
const PAGES = [
  { href: '/smoking', icon: Cigarette, title: '담배 한 대', desc: '폐는 멀쩡, 흡연자랑 나도 함께 할 수 있다.', bg: 'from-[#1a0e06] to-[#050505]', accent: '#fb923c' },
  ...
  { href: '/hamster', icon: Gauge, title: '햄스터 달리기', desc: '햄토리 놀아주기', bg: 'from-[#1a1205] to-[#050505]', accent: '#eab308' },
